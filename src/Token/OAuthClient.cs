...
namespace Laserfiche.Oauth.Api.Client
{
    ...
    public partial interface ITokenApiClient
    {
        ...
        /// </summary>
        /// <param name="client_id">The Client ID returned when the application was registered.</param>
        /// <param name="redirect_uri">The URI to which the OAuth service redirects after the authorization is performed successfully. It should be equal to one of the Redirect URIs specified at the application registration time.</param>
        /// <param name="response_type">Used by the application to inform the authorization server of the desired grant type. The value MUST be "code".</param>
        /// <param name="state">The state of the application. This is intended to help the application manage its state during the request and callback.</param>
        /// <param name="code_challenge">A code challenge used in PKCE extension. This is required for SPAs and optional for Web Applications.</param>
        /// <param name="code_challenge_method">The code challenge method. This is required if a code challenge is used. The value MUST be "S256".</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse> AuthorizeAsync(string client_id = null, string redirect_uri = null, string response_type = null, string state = null, string code_challenge = null, string code_challenge_method = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SwaggerResponse<GetAccessTokenResponse>> TokenAsync(GetAccessTokenRequest body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TokenApiClient : ITokenApiClient
    {
        ...
        /// <param name="code_challenge_method">The code challenge method. This is required if a code challenge is used. The value MUST be "S256".</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse> AuthorizeAsync(string client_id = null, string redirect_uri = null, string response_type = null, string state = null, string code_challenge = null, string code_challenge_method = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse<GetAccessTokenResponse>> TokenAsync(GetAccessTokenRequest body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var urlBuilder_ = new System.Text.StringBuilder();
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new ApiException<OAuthErrorResponse>("A server side error occurred.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
