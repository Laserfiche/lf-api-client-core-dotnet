...
namespace Laserfiche.Api.Client.Lfds
{
    ...
    public partial interface IAccessTokensApiClient
    {
        ...
        /// <br/>            the authToken is returned in the response.</param>
        ...
        System.Threading.Tasks.Task<SessionKeyInfo> CreateAsync(string repoId, CreateConnectionRequest request = null, bool? createCookie = null, string customerId = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AccessTokensApiClient : IAccessTokensApiClient
    {
        ...
        /// <returns>Create an authorizationToken successfuly.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SessionKeyInfo> CreateAsync(string repoId, CreateConnectionRequest request = null, bool? createCookie = null, string customerId = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (repoId == null)
